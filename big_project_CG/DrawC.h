...
void drawHollowC(SDL_Renderer* renderer, int x, int y, int W, int H, SDL_Color color, int thickness) {
	...
	thickLineRGBA(renderer, x, y, x, y + H / 10, thickness, color.r, color.g, color.b, color.a);
	thickLineRGBA(renderer, x, y + H * 9 / 10, x, y + H, thickness, color.r, color.g, color.b, color.a);
}