...
void drawHollowE(SDL_Renderer* renderer, int x, int y, int W, int H, SDL_Color color, int thickness) {
	...
	thickLineRGBA(renderer, x, y + h * 8 , x + W * 3, y + h * 8, thickness, color.r, color.g, color.b, color.a);
	thickLineRGBA(renderer, x, y + H, x + W * 3, y + H, thickness, color.r, color.g, color.b, color.a);
	...
	thickLineRGBA(renderer, x + W * 3, y + h * 8, x + W * 3, y + H, thickness, color.r, color.g, color.b, color.a);
}